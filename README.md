...
dev=(base-devel git b4 aerc patatt lei github-cli curl wget npm cmake gettext docker docker-buildx kubectl helm terraform tree-sitter-cli aws-cli-v2 eksctl opencode)
