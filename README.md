...
dev=(base-devel git github-cli curl wget npm cmake gettext docker docker-buildx kubectl helm terraform tree-sitter-cli aws-cli-v2 eksctl opencode gemini)
